...
Source0  : https://oligarchy.co.uk/xapian/1.4.21/xapian-core-1.4.21.tar.xz
Source1  : https://oligarchy.co.uk/xapian/1.4.21/xapian-core-1.4.21.tar.xz.asc
...
%prep
%setup -q -n xapian-core-1.4.21
cd %{_builddir}/xapian-core-1.4.21
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664149824
...
/usr/lib64/libxapian.so.30.12.2
