...
Source0  : https://oligarchy.co.uk/xapian/1.4.27/xapian-core-1.4.27.tar.xz
Source1  : https://oligarchy.co.uk/xapian/1.4.27/xapian-core-1.4.27.tar.xz.asc
...
%setup -q -n xapian-core-1.4.27
cd %{_builddir}/xapian-core-1.4.27
pushd ..
cp -a xapian-core-1.4.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733583696
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxapian.so.30.13.1
/usr/lib64/libxapian.so.30
/usr/lib64/libxapian.so.30.13.1
