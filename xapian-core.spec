...
Source0  : https://oligarchy.co.uk/xapian/1.4.25/xapian-core-1.4.25.tar.xz
Source1  : https://oligarchy.co.uk/xapian/1.4.25/xapian-core-1.4.25.tar.xz.asc
...
%prep
%setup -q -n xapian-core-1.4.25
cd %{_builddir}/xapian-core-1.4.25
pushd ..
cp -a xapian-core-1.4.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709916571
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxapian.so.30.12.6
/usr/lib64/libxapian.so.30
/usr/lib64/libxapian.so.30.12.6
